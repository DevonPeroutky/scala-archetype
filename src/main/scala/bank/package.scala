...
package object bank {
  ...
  // Data models
  case class BankingEvent(time: LocalDateTime, account: String, action: String, amount: BigDecimal, counterpartyAccount: Option[String]) // TODO, why can't parse Option[String]
